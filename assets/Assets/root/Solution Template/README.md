...
- ### :gear:KytcBoilerplateTemplate.nuspec
	.nuspec files are just used for package metadata (I think...) I'd link to documentation if I had it myself, this has been trail by fire, and Microsoft is an unkind documentorian.    .nuspec files are just used for package metadata (I think...) I'd link to documentation if I had it myself, this has been trail by fire, and Microsoft is an unkind documentorian.    .nuspec files are just used for package metadata (I think...) I'd link to documentation if I had it myself, this has been trail by fire, and Microsoft is an unkind documentorian.    .nuspec files are just used for package metadata (I think...) I'd link to documentation if I had it myself, this has been trail by fire, and Microsoft is an unkind documentorian. 
