...
There's a few interesting things that happen in the background when entities are created/updated/deleted, but that's covered in details in the [auditable entity](../concepts/auditable-entity.md) article.
