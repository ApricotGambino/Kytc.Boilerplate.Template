...
also a [Markdown Cheatsheet](../supporting-files/markdown-cheatsheet.md)
...
**And that's it!**
> [!TIP]
> the `toc.yml` files are files that point to other files or tocs, 'toc' stands for 'Table of Contents'
...
> [!TIP]
> Don't forget to check out the [Markdown Cheatsheet](../supporting-files/markdown-cheatsheet.md)
>
